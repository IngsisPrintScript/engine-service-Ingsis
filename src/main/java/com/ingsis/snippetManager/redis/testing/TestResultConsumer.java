...
// import com.ingsis.snippetManager.redis.dto.TestResultEvent;
...
// LoggerFactory.getLogger(TestResultConsumer.class);
// private final ObjectMapper objectMapper;
// private final SnippetRepo snippetRepository;
// private final ExecutorService executor = Executors.newFixedThreadPool(10);
//
// public TestResultConsumer(@Value("${redis.streams.testResult}") String
// streamName,
// @Value("${redis.groups.test}") String groupName, RedisTemplate<String,
...
// executor.submit(() -> {
// try {
// TestResultEvent event = objectMapper.readValue(record.getValue(),
// TestResultEvent.class);
...
// logger.info("Updated test ({}) status for Snippet({}) -> {}", event.testId(),
// event.snippetId(),
// event.status());
//
// } catch (Exception e) {
...
//
// @Override
// public @NotNull StreamReceiver.StreamReceiverOptions<String,
// ObjectRecord<String, String>> options() {
// return
// StreamReceiver.StreamReceiverOptions.builder().pollTimeout(java.time.Duration.ofSeconds(10))
